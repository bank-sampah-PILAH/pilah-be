...
GS_LOCATION="${GS_LOCATION:-media}"
GS_QUERYSTRING_AUTH="${GS_QUERYSTRING_AUTH:-true}"
GS_IAM_SIGN_BLOB="${GS_IAM_SIGN_BLOB:-false}"
GS_SA_EMAIL="${GS_SA_EMAIL:-}"
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-env-vars="^|^DJANGO_DEBUG=false|DJANGO_ALLOWED_HOSTS=*|CORS_ALLOW_ALL_ORIGINS=true|DB_ENGINE=django.db.backends.postgresql|DB_NAME=${DB_NAME}|DB_USER=${DB_USER}|DB_PASSWORD=${DB_PASSWORD}|DB_HOST=/cloudsql/${SQL_CONNECTION_NAME}|DB_PORT=5432|GS_BUCKET_NAME=${GCS_BUCKET}|GS_LOCATION=${GS_LOCATION}|GS_QUERYSTRING_AUTH=${GS_QUERYSTRING_AUTH}|GS_IAM_SIGN_BLOB=${GS_IAM_SIGN_BLOB}|GS_SA_EMAIL=${GS_SA_EMAIL}|PILAH_ALLOW_FAKE_GOOGLE_TOKEN=false|PILAH_PUBLIC_APP_URL=${PILAH_PUBLIC_APP_URL}|GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID}|GOOGLE_CLIENT_SECRET=${GOOGLE_CLIENT_SECRET}|GOOGLE_REDIRECT_URI=${GOOGLE_REDIRECT_URI}|WHATSAPP_GATEWAY_URL=${WHATSAPP_GATEWAY_URL}|WHATSAPP_GATEWAY_TOKEN=${WHATSAPP_GATEWAY_TOKEN}|TWILIO_ACCOUNT_SID=${TWILIO_ACCOUNT_SID}|TWILIO_AUTH_TOKEN=${TWILIO_AUTH_TOKEN}|TWILIO_API_KEY_SID=${TWILIO_API_KEY_SID}|TWILIO_API_KEY_SECRET=${TWILIO_API_KEY_SECRET}|TWILIO_WHATSAPP_FROM=${TWILIO_WHATSAPP_FROM}|TWILIO_MESSAGING_SERVICE_SID=${TWILIO_MESSAGING_SERVICE_SID}|TWILIO_CONTENT_SID=${TWILIO_CONTENT_SID}|DJANGO_SECRET_KEY=${DJANGO_SECRET_KEY}"
